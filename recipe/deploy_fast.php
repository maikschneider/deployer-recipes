...
/**
 * This file overrides the deploy-fast command in order to switch the commands db:truncate and database:updateschema
 * This done because calling db:truncate without existing database schema would cause an exception.
 * Setting up a fresh host would not be possible. There is a discussion, if this should be changed in the
 * sourcebroker/deployer-extended-typo3 package as well: https://github.com/sourcebroker/deployer-extended-typo3/discussions/18
 */
